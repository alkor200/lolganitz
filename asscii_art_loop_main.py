...
if __name__ == '__main__':
    ...
    while True:
        try:
            # light_manager.run_in_row(interval=0.05)
            # light_manager.run_in_row(reverse=True)
            # light_manager.multiple_run_in_row()
            # light_manager.ping_pong()
            # light_manager.action_1()
            # light_manager.action_2()
            # light_manager.action_3()
            # light_manager.action_4()
            # light_manager.action_5(interval=0.1)
            # light_manager.action_6()
            light_manager.action_7(interval=0.1)
            # light_manager.random_lights(sleep_time=1.1, light_count=3)
